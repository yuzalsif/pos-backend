...
describe('CategoriesController', () => {
  ...
  describe('create', () => {
    it('should create a category for owner', async () => {
      ...
      const req = {
        user: { tenantId: 'tenant1', userId: 'user:1', role: 'owner' },
      };
    ...
    it('should create a category for manager', async () => {
      ...
      const req = {
        user: { tenantId: 'tenant1', userId: 'user:2', role: 'manager' },
      };
      mockCategoriesService.create.mockResolvedValue({
        ...dto,
    ...
    it('should deny access for attendant', () => {
      ...
      const req = {
        user: { tenantId: 'tenant1', userId: 'user:3', role: 'attendant' },
      };

      expect(() => controller.create(dto, req as any)).toThrow(
  ...
  describe('getSubcategories', () => {
    it('should get subcategories', async () => {
      ...
      mockCategoriesService.getSubcategories.mockResolvedValue([
        {
          _id: 'tenant1:category:sub1',
          name: 'Online Sales',
          parentCategoryId: 'tenant1:category:abc',
        },
      ]);
  ...
  describe('update', () => {
    ...
    it('should deny update for attendant', () => {
      ...
      expect(() => controller.update('abc', dto, req as any)).toThrow(
        UnauthorizedException,
      );
    });
  });
  ...
  describe('delete', () => {
    ...
    it('should deny delete for attendant', () => {
      ...
      expect(() => controller.delete('abc', req as any)).toThrow(
        UnauthorizedException,
      );
    });
  });
